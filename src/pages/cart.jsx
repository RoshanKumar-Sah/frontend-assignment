    ...
    return (
        <>
            ...
            <section className="container pt-32 pb-16">
                ...
                <div className="flex flex-col gap-8">
                    {
                        ...
                        cartItems.map(item => {
                            return <div key={item.id}>
                                <div className="border-2 flex shadow group hover:border-primary hover:shadow-primary/50 rounded-md">
                                    <div className="sm:w-[10%] w-1/2 border-2 rounded-md shadow m-8 group-hover:border-primary group-hover:shadow-primary/50 "><Image src={item.image} height={200} width={200} alt="productImage" className="w-full object-fill p-4" /></div>
                                    <div>
                ...
                {
                    cartItems.length == 0 && <div className='h-screen'></div>
                }
