            ...
            <section className="container pt-24">
                {
                    product && <>
                        ...
                        <div className="border shadow-md flex flex-col sm:flex-row p-8 sm:gap-8">
                            <div className="w-full  sm:w-1/2 md:w-1/3  border rounded-md p-8">
                                <Image src={product.image} alt="productImage" height={200} width={200} className="w-full object-fill" />
                            </div>
                            <div>
